...
export default function SignatureMarqueeSection() {
  return (
    <div className="relative bg-white w-full h-full flex flex-col items-center justify-center z-0 overflow-hidden">
        ...
        <div className="w-full overflow-hidden flex">
          ...
          >
            {[...Array(4)].map((_, i) => (
              <h2
                key={i}
                className="text-[12vw] md:text-[8vw] text-blue-700 leading-[0.9] tracking-tight px-4"
              >
        ...
        <div className="w-full overflow-hidden flex">
          ...
          >
            {[...Array(4)].map((_, i) => (
              <h2
                key={i}
                className="font-bold uppercase text-[12vw] md:text-[8vw] text-blue-500 leading-[0.9] tracking-tighter px-4"
              >
