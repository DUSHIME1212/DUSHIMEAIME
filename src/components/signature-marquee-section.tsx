...
export default function SignatureMarqueeSection() {
  return (
    <div className="relative bg-primary w-full h-full flex flex-col items-center justify-center z-0 overflow-hidden">
        ...
        <div className="w-full overflow-hidden flex">
          ...
          >
            {[...Array(4)].map((_, i) => (
              <h2
                key={i}
                className="text-[12vw] md:text-[8vw] font-instrumentserif italic t leading-[0.9] tracking-tight px-4"
              >
        ...
        <div className="w-full overflow-hidden flex">
          ...
          >
            {[...Array(4)].map((_, i) => (
              <h2
                key={i}
                className="font-bold uppercase font-instrumentserif italic text-[12vw] md:text-[8vw] text-white leading-[0.9] tracking-tighter px-4"
              >
                UX/UI Designer | GRAPHIC Designer | Interaction Designer 
              </h2>
            ))}
          </motion.div>
        </div>
